...
messagebox.showinfo("USB","Inserisci la pen drive QUANTUM")
...
# Test
volume_label = "QUANTUM"  # Inserisci il nome della tua pennetta
...
def esegui():
    ...
    if os.path.exists(scrivi_usb):
        messagebox.showinfo('Aggiunta Semiprimi completata')
        pass
    else:
...
canvas.create_text(45, 20, text="GC57 QuantumFhield", fill="red", font=fonte)
